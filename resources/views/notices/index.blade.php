    ...
    <div class="card-body">
        <div class="tab-content">
            ...
            <div class="tab-pane fade" id="forteachers">
                <table class="table table-hover">
                    <thead><tr><th>Title</th><th>Message</th><th>Priority</th><th>Sent by</th><th>Date</th><th>Actions</th></tr></thead>
                    <tbody>
                    ...
                    @empty
                        <tr><td colspan="6" class="text-center text-muted py-4">No notices for teachers.</td></tr>
                    @endforelse
                    </tbody>
                </table>
            </div>
